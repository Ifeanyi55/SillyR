#' Palindrome Extract
#'
#'This function checks for and returns any palindromes in a sentence or vector
#' @param input This can either be a sentence or a vector of string or numeric values
#'
#' @return Returns the palindromes in the input data
#' @export
#'
#' @examples
#' palindromeExtract(c("Dad","Toy","Mum","Car"))
palindromeExtract <- function(input) {
